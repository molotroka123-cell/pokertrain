...
const SCENARIOS = [
  ...
  { hero: ['Ah','Ad'], board: ['Kh','7d','2s'], pos: 'SB (OOP)', villain: 'BTN', pot: 5400, toCall: 0, correct: 'bet', reason: 'AA on K72 in 3-bet pot OOP — you dominate. Small cbet (33%) to keep BTN\'s range wide.', freq: 'Bet 33% 78%, Check 22%' },
  ...
  { hero: ['Kh','Qh'], board: ['9h','6h','2d'], pos: 'SB (OOP)', villain: 'BTN', pot: 5400, toCall: 0, correct: 'bet', reason: 'KQhh on 9h6h2d — nut flush draw + 2 overs. Great semi-bluff. Lead for 50% pot.', freq: 'Bet 50% 70%, Check 30%' },
