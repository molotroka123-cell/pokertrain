...
const SCENARIOS = [
  ...
  { hero: ['Td','9d'], board: ['Jc','8h','3s'], pos: 'BTN', villains: ['CO','BB'], pot: 2400, toCall: 0, correct: 'bet', reason: 'OESD on J83 in 3-way IP — semi-bluff 33% pot. 8 outs + fold equity. Position lets you barrel.', freq: 'Bet 33% 55%, Check 45%' },
